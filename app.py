...
# 4. தேடல் பகுதி
u_input = st.text_input("பங்கின் பெயர் (eg: Reliance, SBI, Coal India)", value="TCS").upper()
...
if stock_loaded:
    ...
    with tab5:
        ...
        except: st.write("தகவல் பெற முடியவில்லை.")
        ...
        try:
            ...
            if news_list:
                for n in news_list[:10]:
                    # பிழை வராமல் இருக்க .get() பயன்படுத்தப்பட்டுள்ளது (KeyError Fix)
